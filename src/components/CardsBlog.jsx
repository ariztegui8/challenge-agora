...
import ecoeficiencia from '@/assets/ecoeficiencia.webp'
        ...
        <div className='grid grid-cols-1 gap-10 lg:gap-6 lg:grid-cols-3'>
            ...
            <div className='relative flex flex-col gap-4'>
                <div className='cursor-pointer rounded-2xl flex lg:overflow-hidden'>
                    ...
                    <img className='w-full h-52 sm:h-64 object-cover rounded-lg' src={ecoeficiencia.src} alt="" />
                </div>
                <div className='rounded-xl flex justify-between flex-col gap-4 flex-1'>
                    <div className='flex flex-col gap-4'>
                        <p className='text-[#333333] font-bold text-lg'>La ecoeficiencia, una vía hacia la competitividad</p>
                        <p className='text-[#333333] text-sm mb-3'>La adopción de la estrategia de ecoeficiencia es una alternativa viable para que las Mipymes avancen en su competitividad e inicien su camino hacia la sostenibilidad.</p>
                    </div>
                    <div className='bg-[#c1285d] text-white text-sm cursor-pointer py-1 px-7 rounded-full hover:bg-[#aa2251] w-max'>
                        <p>CONOCER MÁS</p>
                    </div>
